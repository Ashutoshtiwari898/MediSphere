    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          <p>
            Welcome to MediSphere. Your trusted partner in managing your
            healthcare needs conventiently and efficiently at MediSphere. we
          ...
          <p>
            MediSphere is commited to excellence in healthcare technology. we
            ...
            care. MediSphere is here to support you every step of the way
          </p>
          <p className="text-gray-900 text-lg">Our vision</p>
          <p>
            Our vision at MediSphere is to create a seamless healthcare
